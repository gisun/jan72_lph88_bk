...
//#define FONT_6X8RUS
//#define FONT_7X10RUS_b
//#define FONT_7X10RUS_t
//#define FONT_8X12RUS
//#define FONT_12X16RUS
...
#elif defined(FONT_12X16RUS)
# define FONT_WIDTH  (12)
# define FONT_HEIGHT (16)

#elif defined(FONT_6X8RUS)
# define FONT_WIDTH  (8)
# define FONT_HEIGHT (6)

#elif defined(FONT_7X10RUS_b)
# define FONT_WIDTH  (7)
# define FONT_HEIGHT (10)

#elif defined(FONT_7X10RUS_t)
# define FONT_WIDTH  (7)
# define FONT_HEIGHT (10)
